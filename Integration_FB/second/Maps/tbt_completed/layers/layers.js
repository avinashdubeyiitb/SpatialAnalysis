...
var format_tbt_completed_final_2 = new ol.format.GeoJSON();
var features_tbt_completed_final_2 = format_tbt_completed_final_2.readFeatures(json_tbt_completed_final_2, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:4326'});
var jsonSource_tbt_completed_final_2 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_tbt_completed_final_2.addFeatures(features_tbt_completed_final_2);
var lyr_tbt_completed_final_2 = new ol.layer.Vector({
                declutter: true,
                source:jsonSource_tbt_completed_final_2, 
                style: style_tbt_completed_final_2,
                interactive: true,
    title: 'tbt_completed_final<br />\
    <img src="styles/legend/tbt_completed_final_2_0.png" /> 1 - 1<br />\
    <img src="styles/legend/tbt_completed_final_2_1.png" /> 1 - 1<br />\
    <img src="styles/legend/tbt_completed_final_2_2.png" /> 1 - 3<br />\
    <img src="styles/legend/tbt_completed_final_2_3.png" /> 3 - 4.2<br />\
    <img src="styles/legend/tbt_completed_final_2_4.png" /> 4.2 - 5<br />\
    <img src="styles/legend/tbt_completed_final_2_5.png" /> 5 - 6<br />\
    <img src="styles/legend/tbt_completed_final_2_6.png" /> 6 - 8.4<br />\
    <img src="styles/legend/tbt_completed_final_2_7.png" /> 8.4 - 9.6<br />\
    <img src="styles/legend/tbt_completed_final_2_8.png" /> 9.6 - 12<br />\
    <img src="styles/legend/tbt_completed_final_2_9.png" /> 12 - 13<br />\
    <img src="styles/legend/tbt_completed_final_2_10.png" /> 13 - 18.4<br />\
    <img src="styles/legend/tbt_completed_final_2_11.png" /> 18.4 - 23.8<br />\
    <img src="styles/legend/tbt_completed_final_2_12.png" /> 23.8 - 33.6<br />\
    <img src="styles/legend/tbt_completed_final_2_13.png" /> 33.6 - 54.6<br />\
    <img src="styles/legend/tbt_completed_final_2_14.png" /> 54.6 - 71<br />'
        });
...
lyr_States_0.setVisible(true);lyr_district_map_1.setVisible(true);lyr_tbt_completed_final_2.setVisible(true);lyr_final_elsi_map_databse_3.setVisible(true);
var layersList = [lyr_States_0,lyr_district_map_1,lyr_tbt_completed_final_2,lyr_final_elsi_map_databse_3];
...
lyr_tbt_completed_final_2.set('fieldAliases', {'ST_NM': 'ST_NM', 'count(d.completed)': 'count(d.completed)', });
...
lyr_tbt_completed_final_2.set('fieldImages', {'ST_NM': 'TextEdit', 'count(d.completed)': 'Range', });
...
lyr_tbt_completed_final_2.set('fieldLabels', {'ST_NM': 'header label', 'count(d.completed)': 'header label', });
